...
type ClientInterface interface {
	...
	GetCategoryById(ctx context.Context, id string, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	UpdateCategoryWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	UpdateCategory(ctx context.Context, body UpdateCategoryJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
}
...
func (c *Client) GetCategoryById(ctx context.Context, id string, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) UpdateCategoryWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewUpdateCategoryRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) UpdateCategory(ctx context.Context, body UpdateCategoryJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewUpdateCategoryRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func NewCreateCategoryRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/v1/category/create")
	if operationPath[0] == '/' {
...
func NewGetCategoryByIdRequest(server string, id string) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/v1/category/get/%s", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewGetListRequest(server string, params *GetListParams) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/v1/category/list")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewUpdateCategoryRequest(server string, body UpdateCategoryJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewUpdateCategoryRequestWithBody(server, "application/json", bodyReader)
}

// NewUpdateCategoryRequestWithBody generates requests for UpdateCategory with any type of body
func NewUpdateCategoryRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/v1/category/update")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	...
	GetCategoryByIdWithResponse(ctx context.Context, id string, reqEditors ...RequestEditorFn) (*GetCategoryByIdResponse, error)
	...
	UpdateCategoryWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UpdateCategoryResponse, error)

	UpdateCategoryWithResponse(ctx context.Context, body UpdateCategoryJSONRequestBody, reqEditors ...RequestEditorFn) (*UpdateCategoryResponse, error)
}
...
func (c *ClientWithResponses) GetCategoryByIdWithResponse(ctx context.Context, id string, reqEditors ...RequestEditorFn) (*GetCategoryByIdResponse, error) {
...
func (c *ClientWithResponses) UpdateCategoryWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UpdateCategoryResponse, error) {
	rsp, err := c.UpdateCategoryWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) UpdateCategoryWithResponse(ctx context.Context, body UpdateCategoryJSONRequestBody, reqEditors ...RequestEditorFn) (*UpdateCategoryResponse, error) {
	rsp, err := c.UpdateCategory(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseUpdateCategoryResponse(rsp)
