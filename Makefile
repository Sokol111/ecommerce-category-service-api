...
NPM_PACKAGE_NAME ?= @sokol111/ecommerce-category-service-api
PROJECT_NAME ?= ecommerce-category-service-api
AUTHOR ?= Sokol111
REPOSITORY_URL ?= https://github.com/Sokol111/ecommerce-category-service-api.git
