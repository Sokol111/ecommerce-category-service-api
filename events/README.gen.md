...
- `events.EventTypeCategoryCreated` = "CategoryCreatedEvent"
- `events.EventTypeCategoryUpdated` = "CategoryUpdatedEvent"
...
- **CategoryCreatedEvent**
  - `MarshalCategoryCreatedEvent(event *CategoryCreatedEvent) ([]byte, error)`
  - `UnmarshalCategoryCreatedEvent(data []byte) (*CategoryCreatedEvent, error)`

- **CategoryUpdatedEvent**
  - `MarshalCategoryUpdatedEvent(event *CategoryUpdatedEvent) ([]byte, error)`
  - `UnmarshalCategoryUpdatedEvent(data []byte) (*CategoryUpdatedEvent, error)`

## Available Schemas

- `events.CategoryCreatedSchema` - CategoryCreatedEvent (embedded Avro schema)
- `events.CategoryUpdatedSchema` - CategoryUpdatedEvent (embedded Avro schema)
